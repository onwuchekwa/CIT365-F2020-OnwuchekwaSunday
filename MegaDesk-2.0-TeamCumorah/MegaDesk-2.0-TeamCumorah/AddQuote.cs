        ...
        private void btnAddNewQuote_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                JObject jObject = new JObject(
                      new JProperty("customerName", _customerName)
                    , new JProperty("transactionDate", DateTime.Now)
                    , new JProperty("rashDays", rushDays)
                    , new JProperty("deskMaterial", deskMaterial)
                    , new JProperty("deskDrawer", deskDrawer)
                    , new JProperty("deskWidth", deskWidth)
                    , new JProperty("deskDepth", deskDepth)
                    , new JProperty("deskArea", deskQuote.calcArea())
                    , new JProperty("sizeOverage", deskQuote.calcSizeOverage())
                    , new JProperty("sizeCost", deskQuote.calcSizeCost())
                    , new JProperty("drawerCost", deskQuote.calcDrawer())
                    , new JProperty("materialCost", deskQuote.calcMaterial())
                    , new JProperty("shippingCost", deskQuote.calcShippingCost())
                    , new JProperty("totalCost", deskQuote.calcQuote())
                );

                string fileName = @"data/quotes.json";
                ...
                MessageBox.Show("The order details has been submitted." + jObject);
